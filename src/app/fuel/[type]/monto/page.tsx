  ...
  return (
    <div className="min-h-screen w-full bg-white flex items-center justify-center">
      <main className="w-full max-w-5xl px-6 py-12">
        <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-6 text-center">Monto - {label}</h1>
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            <p className="text-2xl text-slate-700 mb-2">Ingrese el monto (Q)</p>
            <Keypad
              value={val}
              onChange={setVal}
          ...
          <div className="md:w-72 w-full space-y-4">
            <div className="p-6 rounded-md border border-slate-200">
              ...
              <p className="text-4xl font-semibold mt-2 text-slate-900">Q {val || 0}</p>
            </div>
